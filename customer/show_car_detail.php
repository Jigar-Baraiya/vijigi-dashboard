...
<body class="bg-body">
     ...
     <div class="p-3 my-3  text-white op" style="opacity: 0.8;">
          <?php
          include("nav.php")
               ?>
          <br />
          ...
          <div class="row">
               <div class="card col my-3 m-2" style="width: 18rem;">
                    <div class="card-body">
                         ...
                         <p class="card-title">Regen Level</p>
                    </div>
               </div>
          ...
          <div align="right">
               <a href='index.php' class='btn btn-info my-2 my-sm-0 btn-lg'>Back</a>
          </div>
     </div>
